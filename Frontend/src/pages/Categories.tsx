...
// ✅ FIX: nueva sintaxis de useQuery
const { data, isLoading, error } = useQuery({
queryKey: ["categories"],
queryFn: getCategories,
});

// ✅ FIX: nueva sintaxis de useMutation
...
<Row gutter={[16, 16]}> <Col xs={24} lg={16}> <Card title="Categorías">
{error ? (
<p style={{ color: "red" }}>
No se pudo cargar la lista de categorías. </p>
) : (
<List
